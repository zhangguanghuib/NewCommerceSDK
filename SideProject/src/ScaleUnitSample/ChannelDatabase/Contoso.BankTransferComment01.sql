...
CREATE TABLE [ext].[CONTOSORETAILTRANSACTIONPAYMENTTRANS](
	[BANKTRANSFERCOMMENT] [nvarchar](25) NOT NULL,
 ...
 CONSTRAINT [PK_EXT_CONTOSORETAILTRANSACTIONPAYMENTTRANS] PRIMARY KEY CLUSTERED 
(
	[CHANNEL] ASC,
	[STORE] ASC,
	[TERMINAL] ASC,
...
CREATE PROCEDURE [ext].[INSERTCONTOSORETAILTRANSACTIONPAYMENTTRANS]
    ...
    @s_BANKTRANSFERCOMMENT [nvarchar](25)
AS
BEGIN
    SET NOCOUNT ON

    INSERT INTO
         [ext].[INSERTCONTOSORETAILTRANSACTIONPAYMENTTRANS]
        (CHANNEL,STORE,TERMINAL, DATAAREAID, TRANSACTIONID, LINENUM, BANKTRANSFERCOMMENT)
    VALUES
        (@b_CHANNEL, @s_STORE, @s_TERMINAL, @s_TRANSACTIONID, @n_LINENUM, @s_DATAAREAID, @s_BANKTRANSFERCOMMENT)
END;
GO
