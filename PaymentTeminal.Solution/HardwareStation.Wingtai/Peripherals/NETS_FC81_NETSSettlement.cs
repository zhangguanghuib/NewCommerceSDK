...
{
    public class NETS_FC81_NETSSettlement : NETS
    {
        ...
        protected override byte[] constructRequestMessageToTerminal(string _amount, string _ECR)
        {
            try
            {                
                byte[] MessageHeader = GetMessageHeader("81");//1C 02-00-83-30-30-30-30-30-30-30-30-30-30-30-30-33-30-30-30-30-1C-
                ...
                logHelper.saveLog(test.ToString());
