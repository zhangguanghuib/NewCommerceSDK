...
export default class ExampleViewModel {
    ...
    /**
     * Creates an example entity by calling the appropriate request from the CommerceRuntime bound controller added.
     */
    ...
    /**
     * Edits an example entity by calling the appropriate request from the CommerceRuntime bound controller added.
     */
    ...
    /**
     * Deletes an example entity by calling the appropriate request from the CommerceRuntime bound controller added.
     */
    ...
    /**
     * Runs a ping test by calling the appropriate request from the CommerceRuntime unbound controller added.
     */
