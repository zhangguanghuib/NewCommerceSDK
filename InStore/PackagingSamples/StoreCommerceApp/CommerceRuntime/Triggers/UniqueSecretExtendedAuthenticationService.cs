...
namespace Contoso.Commerce.Runtime.ExtendedLogonSample
{
    ...
    public abstract class UniqueSecretExtendedAuthenticationService : INamedRequestHandlerAsync
    {
        ...
        public async Task<Response> Execute(Request request)
        {
            ...
            {    
                case GetUserAuthenticationCredentialIdServiceRequest getUserAuthenticationCredentialIdServiceRequest:
                    return await this.GetUserAuthenticationCredentialId(getUserAuthenticationCredentialIdServiceRequest).ConfigureAwait(false);
                case OverrideUserCredentialServiceRequest overrideUserCredentialServiceRequest:
                    return await this.OverrideUserCredential(overrideUserCredentialServiceRequest).ConfigureAwait(false);
                ...
                case GetUserEnrollmentDetailsServiceRequest getUserEnrollmentDetailsServiceRequest:
                    return await request.RequestContext.ExecuteAsync<Response>(request).ConfigureAwait(false);
                default:
        ...
        private async Task<Response> OverrideUserCredential(OverrideUserCredentialServiceRequest request)
        {
            ...
            if (extraParameters != null && extraParameters.TryGetValue(ExtraParameterPinKey, out object value))
            {
                pin = value.ToString();
            }
            ...
            return await Task.FromResult(new OverrideUserCredentialServiceResponse(credential) as Response).ConfigureAwait(false);
        }
