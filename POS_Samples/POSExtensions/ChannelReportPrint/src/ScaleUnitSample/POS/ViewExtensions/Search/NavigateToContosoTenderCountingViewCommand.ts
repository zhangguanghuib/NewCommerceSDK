...
export default class NavigateToContosoTenderCountingViewCommand extends SearchView.ProductSearchExtensionCommandBase {
    /**
    ...
    constructor(context: IExtensionCommandContext<SearchView.IProductSearchToExtensionCommandMessageTypeMap>) {
        ...
        this.id = "NavigateToContosoTenderCountingViewCommand";
        this.label = "Navigate to ContosoTenderCountingView";
    ...
    protected execute(): void {
        this.context.navigator.navigate("ContosoTenderCountingView");
    }
}