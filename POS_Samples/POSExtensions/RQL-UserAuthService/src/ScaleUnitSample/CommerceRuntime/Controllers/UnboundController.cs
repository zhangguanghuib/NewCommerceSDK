namespace Contoso.CommerceRuntime.Controllers
{
    ...
    public class UnboundController : IController
    {
        ...
        public async Task<bool> SimplePingGet(IEndpointContext context)
        {
            GetEmployeeIdentityByExternalIdentityRealtimeRequest getEmployeeIdentityByExternalIdentityRealtimeRequest
                = new GetEmployeeIdentityByExternalIdentityRealtimeRequest("", "5bf05ec4-ba9e-4000-a0fa-d9c81e778fa6");

            await context.ExecuteAsync<GetEmployeeIdentityByExternalIdentityRealtimeResponse>(getEmployeeIdentityByExternalIdentityRealtimeRequest).ConfigureAwait(false); ;
