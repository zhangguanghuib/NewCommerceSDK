...
export default class ExampleViewModel {
    ...
    public runPingTest(): Promise<void> {
        ...
        return this._context.runtime.executeAsync(getCartRequest).then((value: ClientEntities.ICancelableDataResult<GetCurrentCartClientResponse>) => {
            let cart: Commerce.Proxy.Entities.Cart = (<GetCurrentCartClientResponse>value.data).result;
            this._context.runtime.executeAsync(new Messages.StoreOperations.SimplePingGetRequest(cart.Id))
