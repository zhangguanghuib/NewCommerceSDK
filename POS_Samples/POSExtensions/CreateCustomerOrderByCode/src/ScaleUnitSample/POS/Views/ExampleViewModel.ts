...
export default class ExampleViewModel {
    ...
    public runPingTest(): Promise<void> {
        ...
        return this._context.runtime.executeAsync(getCurrentCartClientRequest).then((response: ClientEntities.ICancelableDataResult<GetCurrentCartClientResponse>) => {
            return this._context.runtime.executeAsync(new Messages.StoreOperations.SimplePingGetRequest(response.data.result.Id));
            ...
            return this._context.runtime.executeAsync(refreshCartClientRequest);
        }).then((res: ClientEntities.ICancelableDataResult<RefreshCartClientResponse>) => {
                return this._context.runtime
                    ...
                    .then(pingPostResponse => {
                        ...
                        return pingResultDialog.open(res.data.result.Id!='', pingPostResponse.data.result);
                    });
