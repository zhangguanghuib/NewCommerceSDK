DROP PROCEDURE IF EXISTS [ext].[SETTRANSACTIONPRINTED_V2];
GO
...
GRANT EXECUTE ON [ext].[SETTRANSACTIONPRINTED_V2] TO [UsersRole];
GO

GRANT EXECUTE ON [ext].[SETTRANSACTIONPRINTED_V2] TO [DeployExtensibilityRole];
GO
