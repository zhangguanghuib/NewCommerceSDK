...
export class TenderCountingLine {
    ...
    constructor(
        ...
        this.totalAmountInCurrencyToDisplay =
            CurrencyFormatter.toCurrency(this.totalAmountInCurrency) + this.currencyCode;
        ...
        this.ariaLabelPaymentTotal = Commerce.StringExtensions.format( "{0} total {1}", this.tenderName, this.totalAmountInCurrencyToDisplay);
