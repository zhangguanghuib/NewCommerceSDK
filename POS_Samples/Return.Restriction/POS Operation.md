# POS operation demonstration
   ...
   <ol>
      ...
      <li>
         There is an important thing that is how we can know which cart line is selected,  the way is to make CartViewController to record which line will be selected:
