...
{
    public class DBSEngineX64
    {
        #region import 64 bit Process
        const string SPECTRA_ECRDLL_x64 = "DBSDLL/x64/ECR64Win7.dll";

        [DllImport(SPECTRA_ECRDLL_x64)]
        ...
        public static DataContract.DBSResponse Run(string comPort, string ecr_msg)
        {
            ...
            try
            {
                if (OpenConnection(comPort, "9600,n,8,1") == 1)
                {
                    ...
                    CloseConnection();
                    System.Diagnostics.Debug.WriteLine("[ OK ] CloseConnection");
