...
export default class DualDisplayCustomControl extends DualDisplayCustomControlBase {
    ...
    public readonly ommaContentUrl: ko.Computed<string>;
    ...
    constructor(id: string, context: IDualDisplayCustomControlContext) {
        ...
        this.ommaContentUrl = ko.computed(() => {
            //return ObjectExtensions.isNullOrUndefined(Commerce.ApplicationContext.Instance.hardwareProfile.DualDisplayWebBrowserUrl) ? StringExtensions.EMPTY : Commerce.ApplicationContext.Instance.hardwareProfile.DualDisplayWebBrowserUrl;
            //return "https://github.com/zhangguanghuib/NewCommerceSDK/blob/main/POS_Samples/RemoveAppliedCoupons/Demo.gif";
            return "Demo.gif";
        });
