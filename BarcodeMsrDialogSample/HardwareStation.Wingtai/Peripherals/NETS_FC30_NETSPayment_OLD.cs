...
{
    public class NETS_FC30_NETSPayment_OLD : NETS
    {
        ...
        {            
            try
            {
                ...
                byte[] MessageHeader = GetMessageHeader("30");//1C 02-00-83-30-30-30-30-30-30-30-30-30-30-30-30-33-30-30-30-30-1C-
                byte[] MessageDataT2 = GenerateMessageData("T2", 2, "01");//1C
                byte[] MessageDataLoyalty = GenerateMessageData("43", 1, "0");//1C
                ...
                byte[] buffer = new byte[MessageHeader.Length + MessageDataT2.Length + MessageDataLoyalty.Length + MessageDataTransaction.Length + MessageDataCashBack.Length + MessageDataECR.Length + 3];
                ...
                lst.Add(0x1C);
                lst.AddRange(MessageDataT2);
                lst.Add(0x1C);
                lst.AddRange(MessageDataLoyalty);
                lst.Add(0x1C);
                ...
                List<byte> FullCommand = new List<byte>();//messageLength.OfType<byte>().ToList();
                ...
                //DebugHardWrite("BYTE SEND: " + test.ToString());
