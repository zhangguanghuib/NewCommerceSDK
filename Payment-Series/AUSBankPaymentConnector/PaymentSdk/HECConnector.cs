...
namespace Microsoft.Dynamics
{
    namespace Retail.SampleConnector.Portable
    {
        ...
        /// <summary>
        /// HECConnector class (Portable Class Library version).
        /// </summary>
        ...
        public class HECConnector : SampleProcessorIdentifier, IPaymentProcessor, IPaymentProcessorExtension, IPaymentReferenceProvider, IPaymentMethodInfo
        {
            #region Constants
        ...
        private const string DefaultEnvironment = "INT";
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="HECConnector"/> class.
            /// </summary>
            public HECConnector()
            {
            }
            ...
            public Response Authorize(Request request, PaymentProperty[] requiredInteractionProperties)
            {
                ...
                PaymentUtilities.LogOperationResult(methodName, this.Name, HECConnector.Platform, request, response);
            ...
            public Response GetPaymentAcceptPoint(Request request)
            {
                ...
                //{
                    ...
                    //    acceptPointResponse.PaymentAcceptUrl = null;
                    acceptPointResponse.PaymentAcceptSubmitUrl = "https://prod-17.australiasoutheast.logic.azure.com/workflows/815185dc64354dca9289b56bceee363d/triggers/manual/paths/invoke/Address/HCM/ItemId/1223?api-version=2016-06-01&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=BYdRNmN6IYu5NzQH5rUoWGmTUBDBJatPm8mJY9_c0k4";
                    acceptPointResponse.PaymentAcceptPageContents = PaymentSdk.HECConnector.Sample.Properties.Resources.PaymentAcceptPageContentsHtml;
                //}
                //else
                //{
            ...
            private static List<PaymentError> ProcessActivateGiftCardResult(ActivateGiftCardResponse response, ActivateGiftCardRequest request)
            {
                ...
                */
                ...
                bool approvalHasFailed = response.AvailableBalance == HECConnector.declinedAmount || hasBeenActivated;
            ...
            private static List<PaymentError> ProcessLoadGiftCardResult(LoadGiftCardResponse response, LoadGiftCardRequest request)
            {
                ...
                */
                ...
                switch (string.Format("{0:0.00}", request.Amount))
                {
                    // Authorization result
                    case TestData.AuthorizationDeclined:
                        SetLoadGiftCardResult(response, HECConnector.declinedAmount, LoadGiftCardResult.Failure, "Declined", errors, ErrorCode.Decline);
                        break;
                    case TestData.AuthorizationNone:
                        SetLoadGiftCardResult(response, HECConnector.declinedAmount, LoadGiftCardResult.None, "Declined", errors, ErrorCode.Decline);
                        break;
                    default:
