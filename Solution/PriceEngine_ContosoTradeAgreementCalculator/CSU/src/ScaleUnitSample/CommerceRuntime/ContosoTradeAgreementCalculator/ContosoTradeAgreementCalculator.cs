namespace Contoso.PricingEngine.TradeAgreementCalculator
{
    ...
    { 
        ...
        internal static IEnumerable<OrgUnitLocation> GetVariablesFromInternalPricetext(PriceContext priceContext, out string channelWarehouseId)
        {
            Type type = priceContext.GetType();
            IEnumerable<OrgUnitLocation> allStores = null;
            channelWarehouseId = string.Empty;
                ...
                IPricingDataAccessor pricingDataManager)
        {
            ...
            IEnumerable<OrgUnitLocation> allStores = GetVariablesFromInternalPricetext(priceContext, out channelWarehouseId);
