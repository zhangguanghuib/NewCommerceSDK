...
<img width="617" alt="image" src="https://github.com/zhangguanghuib/NewCommerceSDK/assets/14832260/c3989786-2fe4-4bfb-8644-b50040882e1a">
1. You machine should also install the SQL Server(or SQL express), and make sure it is mixed-authentication mode:
