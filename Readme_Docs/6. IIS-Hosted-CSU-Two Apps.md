...
9.  Create Channel Profile:
    <img width="728" alt="image" src="https://github.com/zhangguanghuib/NewCommerceSDK/assets/14832260/cfafb9e0-2c11-49fc-8adc-ad7caaff34b4">

    Create Channel Database

    Create Channel Database Group
