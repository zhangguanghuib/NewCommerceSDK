...
- Step 2: Check the Distribution Scheduler and Jobs and Subjobs created by above XML.<br/>
  ...
  <img width="708" alt="image" src="https://github.com/user-attachments/assets/675e630a-46dc-4974-8ae5-00abe7094282"><br/> 7. <mark>RetailCustTable=> Download Session=>Existing table with existing columns and new columns</mark><br/>
...
- Step 4: How to verify the custome CDX is working or not? <br/>
  ...
  - <mark>RetailTrasactionTable and RetailTransactionPaymentTrans=>Upload Sessions=>Exend Existing Table to add new fields</mark><br/>
    ...
    ![image](https://github.com/user-attachments/assets/1d65b76f-1a39-4cf8-82cd-0850700c4064)<br/> 2. You can see after run P-Job, the custom fields column values are uploaded to D365 F&O Head Quarter:<br/>
