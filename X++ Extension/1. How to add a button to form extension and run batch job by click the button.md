# This document is to showcase how to add a button to OOB form and then add click event handler for this button,  and when click the button a batch job will execute
