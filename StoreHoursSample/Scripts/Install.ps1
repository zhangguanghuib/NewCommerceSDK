...
$extensionInstallPath = Join-Path $baseProductInstallRoot "Extensions\GHZ.StoreHoursSample.ScaleUnit.Installer"
...
& "$workspaceFolder\ScaleUnit.Installer\bin\Debug\net461\GHZ.StoreHoursSample.ScaleUnit.Installer.exe" install
